...
class NavbarUser extends React.PureComponent {
  ...
  componentDidMount() {
    switch (true) {
      case this.state.role.includes(UserRoles.User):
        this.setState({ roleName: "کاربر" });
        break;
      case this.state.role.includes(UserRoles.Admin):
        this.setState({ roleName: "ادمین" });
        break;
      case this.state.role.includes(UserRoles.IdeaResponsible):
        this.setState({ roleName: "مسئول ایده" });
        break;
      case this.state.role.includes(UserRoles.StartupResponsible):
        this.setState({ roleName: "مسئول استارتاپ" });
        break;
      default:
        break;
    }
