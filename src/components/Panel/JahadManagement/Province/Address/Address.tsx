...
import Style from "./ProvinceAddress.module.scss";
import { MapDetails } from "../../../../common/Map/MapDetails/MapDetails";
import { JahadProvinceAddressValidation } from "./../../../../../core/validations/jahadProvince-address.validation";
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={onSubmit}
        validationSchema={JahadProvinceAddressValidation}
      >
