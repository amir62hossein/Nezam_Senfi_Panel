...
import { JahadMainLocationContactUsValidation } from "./../../../../../core/validations/jahadMainLocation-contact-info.validation";
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={onSubmit}
        validationSchema={JahadMainLocationContactUsValidation}
      >
