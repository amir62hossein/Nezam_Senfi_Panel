...
import Styled from "./LiveStockAddress.module.scss";
import { LiveStockAddressValidation } from "../../../../../core/validations/liveStock-address.validation";
type Props = {};
...
export default function LiveStockAddress({}: Props) {
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={onSubmit}
        validationSchema={LiveStockAddressValidation}
      >
