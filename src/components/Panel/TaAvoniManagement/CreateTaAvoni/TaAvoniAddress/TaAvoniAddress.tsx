...
import { TaAvoniAddressValidation } from "./../../../../../core/validations/taAvoni-address.validation";
import Style from "./TaAvoniAddress.module.scss";
type Props = {};
...
export default function TaAvoniAddress({}: Props) {
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={onSubmit}
        validationSchema={TaAvoniAddressValidation}
      >
