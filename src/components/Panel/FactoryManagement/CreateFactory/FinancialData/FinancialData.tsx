...
import { FactoryFinancialDataValidation } from "./../../../../../core/validations/factory-financialData.validation";
type Props = {};
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={onSubmit}
        validationSchema={FactoryFinancialDataValidation}
      >
