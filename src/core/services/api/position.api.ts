...
const postGetProvinceGuildRoomPosition = async (
  data: any
...
const postGetAllProvinceGuildRoomPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const postGetContyGuildRoomPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const postGetUnionCountyPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const SetPositionInProvinceGuildRoom = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const SetPositionInMainLocationGuildRoom = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const GetAllMainLocationGuildRoomPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const GetAllContyGuildRoomPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const GetAllUnionCountyPosition = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const SetPositionInCountyUnion = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
...
const SetPositionInCountyGuildRoom = async (
  data: any
): Promise<AxiosResponse<IAxiosResult>> => {
  return await methods.post(
